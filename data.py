...
def job():
    ...
    ET.SubElement(root, "matchteam").text = headerRe
    ...
    with open(cwd + "\\" + headerRe + ".csv", "a", newline='') as csvfile:
    ...
    fh = open(cwd + "\\" + headerRe + ".csv", 'rb')
    fl = open(cwd + "\\" + headerRe + ".xml", 'rb')
    csvfilename = headerRe + ".csv"
    xmlfilename = headerRe + ".xml"
